...
@Slf4j
public class MemberRepository6 implements MemberRepositoryInter{

    private final DataSource dataSource;
    private final SQLExceptionTranslator exceptionTranslator;

    public MemberRepository6(DataSource dataSource) {
    ...
    public Member save(Member member) {
        ...
        try {
            ...
            throw exceptionTranslator.translate("save", sql, e); // JDBC 예외를 spring 예외로 변환
        } finally {
